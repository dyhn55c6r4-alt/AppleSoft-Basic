# Applesoft BASIC for 6502 Microprocessor - Version 1.1

## Historical Significance

This assembly language source code represents one of the most historically significant pieces of software from the early personal computer era. It is the complete source code for **Applesoft BASIC Version 1.1 for the 6502 microprocessor**, originally developed and copyrighted by Apple in 1976-1978.
...
#### 2. Apple’s Early Success

- This represents some of Microsoft's earliest and most successful software
- The licensing of this BASIC interpreter to multiple computer manufacturers was crucial to Apple’s early business model
- It established Apple as a dominant force in personal computer software before MS-DOS or Windows 
...
- Apple’s BASIC became the de facto standard for personal computer programming
...
- The licensing of this software to multiple hardware manufacturers created Apple’s early business model
...
- The development of Apple-DOS and subsequent Apple operating systems
...
- **Copyright**:  Apple Computer Inc, 1976-1978
- **Version**: 1.1
- **Assembly Format**: Compatible with period assemblers for 6502 development

---

*This document represents a crucial piece of computing history - the source code that helped launch the personal computer revolution and established Apple as a software industry leader.*
